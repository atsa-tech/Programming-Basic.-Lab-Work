...
##### Вызову print() - call
##### Разгрузка констант - LOAD_CONST
##### Функция вывода - CALL

#### Ответ на контрольный вопрос
    Байткод CPython нельзя считать машинным кодом, потому что он предназначен для выполнения виртуальной машиной (CPython), а не напрямую физическим процессором компьютера
